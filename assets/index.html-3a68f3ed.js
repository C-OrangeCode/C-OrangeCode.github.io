import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as i,c,a as s,b as n,d as e,e as p}from"./app-a1fbcbb6.js";const o={},u=p('<h1 id="less基础" tabindex="-1"><a class="header-anchor" href="#less基础" aria-hidden="true">#</a> Less基础</h1><h2 id="_1-维护css的弊端" tabindex="-1"><a class="header-anchor" href="#_1-维护css的弊端" aria-hidden="true">#</a> 1.维护CSS的弊端</h2><p>CSS 是一门非程序式语言，没有变量、函数、SCOPE（作用域）等概念。</p><ul><li>CSS 需要书写大量看似没有逻辑的代码，CSS 冗余度是比较高的</li><li>不方便维护及扩展，不利于复用</li><li>CSS 没有很好的计算能力</li><li>非前端开发工程师来讲，往往会因为缺少 CSS 编写经验而很难写出组织良好且易于维护的 CSS 代码项目</li></ul><h2 id="_2-less介绍" tabindex="-1"><a class="header-anchor" href="#_2-less介绍" aria-hidden="true">#</a> 2.Less介绍</h2><p>Less（Leaner Style Sheets 的缩写）是一门 CSS 扩展语言，也称为 CSS 预处理器。</p><p>做为 CSS 的一种形式的扩展，它并没有减少 CSS 的功能，而是在现有的 CSS 语法上，为 CSS 加入程序式语言的特性。</p><p>它在 CSS 的语法基础上，引入了变量，Mixin（混入），运算以及函数等功能，大大简化了 CSS 的编写，并且降低了 CSS 的维护成本，就像它的名称所说的那样，Less 可以让我们用更少的代码做更多的事情。</p>',8),r={href:"https://less.bootcss.com/",target:"_blank",rel:"noopener noreferrer"},d=s("p",null,"常见的 CSS 预处理器：Sass、Less、Stylus",-1),v=s("p",null,"一句话：Less 是一门 CSS 预处理语言，它扩展了 CSS 的动态特性。",-1),k=s("h2",{id:"_3-less安装-注意如果使用vscode无需安装less",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_3-less安装-注意如果使用vscode无需安装less","aria-hidden":"true"},"#"),n(" 3.Less安装（注意如果使用VSCode无需安装Less）")],-1),m=s("p",null,[s("strong",null,"用node运行Less")],-1),b={href:"http://nodejs.cn/download/",target:"_blank",rel:"noopener noreferrer"},h=s("li",null,[n("检查是否安装成功，使用 cmd 命令输入 "),s("code",null,"node -v"),n(" 查看版本即可")],-1),g=s("li",null,[n("基于 node.js 在线安装 Less，使用 cmd 命令输入 "),s("code",null,"npm install -g less"),n(" 即可")],-1),x=s("li",null,[n("检查是否安装成功，使用 cmd 命令 "),s("code",null,"lessc -v"),n(" 查看版本即可")],-1),y=p(`<p><strong>vscode使用Less</strong></p><p>本质上，Less 包含一套自定义的语法及一个解析器，用户根据这些语法定义自己的样式规则，这些规则最终会通过解析器，编译生成对应的 CSS 文件。</p><p>所以，我们需要把我们的 Less 文件，编译生成为 CSS 文件，这样我们的 HTML 页面才能使用。</p><p>【VSCode Less 插件】</p><p>vscode 的 Easy LESS 插件</p><p>这个插件可以自动将<code>less</code>文件转义成<code>css</code>文件<br><strong>关于配置</strong></p><figure><img src="https://i0.hdslb.com/bfs/album/414fbd1d48b8bce8313ae5ddc66469d7b3548974.png" alt="image-20220820200608896" tabindex="0" loading="lazy"><figcaption>image-20220820200608896</figcaption></figure><p><strong>settings.json配置如下</strong></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;less.compile&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,113);function _(f,S){const a=l("ExternalLinkIcon");return i(),c("div",null,[u,s("p",null,[n("Less 中文网址："),s("a",r,[n("Less 快速入门 | Less.js 中文文档 - Less 中文网 (bootcss.com)"),e(a)])]),d,v,k,m,s("ol",null,[s("li",null,[n("安装 node.js，可选择版本（8.0），网址："),s("a",b,[n("http://nodejs.cn/download/"),e(a)])]),h,g,x]),y])}const C=t(o,[["render",_],["__file","index.html.vue"]]);export{C as default};
